...
class SparkAppHandleToObservableSpec extends WordSpec with Matchers with ScalaFutures {

  import SparkAppHandleToObservableSpec._
...
object SparkAppHandleToObservableSpec {
